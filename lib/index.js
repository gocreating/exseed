...
exports.App = exports.Waterline = exports.env = exports.ENV = undefined;
...
var Waterline = exports.Waterline = _waterline3.default;

var rootExpressApp = (0, _express3.default)();
...
function registerApp(appName, appClass) {
  var expressApp = (0, _express3.default)();
...
function init(customSettings, cb) {
  ...
  // initialize ORM
  _waterline.initialize(appSettings.db[ENV], function (err, ontology) {
    if (err) {
      return cb(err);
    }
